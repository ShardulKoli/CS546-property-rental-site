...
for (let i = 0; i <= numOfStudents; i++) {
    try {
        let NewUser = routesUser.createUser("User :" + i, "Demo Lastname :" + i, "User" + i + "@demo.edu", "Student", 1234567890, "User@" + i);
    }
    catch (error) {
        console.log(error);
...
for (let i = 0; i <= numOfBrokers; i++) {
    try {
        let NewUser = routesUser.createUser("Broker :" + i, "Demo Lastname :" + i, "Broker" + i + "@demo.com", "Broker", 1234567890, "Broker@" + i);
    }
    catch (error) {
        console.log(error);
